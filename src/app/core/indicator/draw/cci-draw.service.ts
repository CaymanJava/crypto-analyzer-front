...
export class CciDrawService extends CommonDrawService {

  draw(settings: IndicatorSettings, result: any[], chart: any, currentPlotNumber: number): IndicatorDrawResult {
    const plotNumber = currentPlotNumber + 1;
    return this.drawCCI(settings, result, chart, plotNumber);
  }
  ...
  private drawCCI(settings: IndicatorSettings, result: any[], chart: any, plotNumber: number): IndicatorDrawResult {
  ...
  private configurePlot(chart: any, plotNumber: number, indicatorMapping) {
    ...
    super.addHorizontalLine(indicatorPlot, 100);
    super.addHorizontalLine(indicatorPlot, -100);
