...
@Component({
  moduleId: module.id,
  templateUrl: './moving-average-convergence-divergence.component.html'
})
export class MovingAverageConvergenceDivergenceComponent extends BaseIndicatorComponent {
